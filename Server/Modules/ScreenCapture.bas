...
'Public Function CreateBitmapPicture(ByVal imageStr As String) As Picture

'Public Function CreateBitmapPicture(ByVal hDCMemory As Long) As Picture
...
'    vLen = Int(Left(imageStr, 6))

'    hBmp = Mid(imageStr, 7, vLen)
'    hPal = Right(imageStr, Len(imageStr) - (vLen + 7))
...
Public Function CaptureWindow(ByVal hWndSrc As Long, _
    ...
    ByVal HeightSrc As Long) As Long 'As Picture 'As String
